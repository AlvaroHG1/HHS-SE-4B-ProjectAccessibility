            ...
            <div>
                <div className="register-ervaringdeskundige-container">
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <h2>Voornaam</h2>
                        <input type="text" name="voornaam" value={voornaam} placeholder="Voer uw voornaam in..."
                               onChange={this.handleInputChange}/>
                        <h2>Achternaam</h2>
                        <input type="text" name="achternaam" value={achternaam} placeholder="Voer uw achternaam in..."
                               onChange={this.handleInputChange}/>
                        <h2>Geboortedatum</h2>
                        <input type="date" name="geboortedatum" value={geboortedatum}
                               onChange={this.handleInputChange}/>
                        <h2>Straatnaam</h2>
                        <input type="text" name="straatnaam" value={straatnaam} placeholder="Voer uw straatnaam in..."
                               onChange={this.handleInputChange}/>
                        <h2>Huisnummer</h2>
                        <input type="text" name="huisnummer" value={huisnummer} placeholder="Voer uw huisnummer in..."
                               onChange={this.handleInputChange}/>
                        <h2>Plaats</h2>
                        <input type="text" name="plaats" value={plaats} placeholder="Voer uw plaatsnaam in..."
                               onChange={this.handleInputChange}/>
                        <h2>Postcode</h2>
                        <input type="text" name="postcode" value={postcode} placeholder="Voer uw postcode in..."
                               onChange={this.handleInputChange}/>
                        <h2>Email-adres</h2>
                        <input type="email" name="email" value={email} placeholder="Voer uw email-adres in..."
                               onChange={this.handleInputChange}/>
                        <h2>Wachtwoord</h2>
                        <input type="password" name="wachtwoord" value={wachtwoord}
                               placeholder="Voer uw wachtwoord in..." onChange={this.handleInputChange}/>
